...
[![All Contributors](https://img.shields.io/github/all-contributors/langestefan/DocumenterDocstringStyle.jl?labelColor=5e1ec7&color=c0ffee&style=flat-square)](#contributors)
...
If you want to make contributions of any kind, please first that a look into our [contributing guide directly on GitHub](docs/src/90-contributing.md) or the [contributing page on the website](https://langestefan.github.io/DocumenterDocstringStyle.jl/dev/90-contributing/)
